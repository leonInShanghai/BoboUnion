...
public class ScrollingUtil {
    ...
    public static boolean isViewToBottom(View view, int mTouchSlop) {
        ...
        if (view instanceof TbNestedScrollView) {
            return isTbNestedScrollViewoBottom((TbNestedScrollView) view);
        }
    ...
    /**
     * 2020-1-10修改第三方的代码 判断是否划动到了底部（允许上拉加载更多）
     * @param view
     * @return
     */
    private static boolean isTbNestedScrollViewoBottom(TbNestedScrollView view) {
