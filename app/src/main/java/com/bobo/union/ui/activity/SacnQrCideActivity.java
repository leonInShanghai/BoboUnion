...
public class SacnQrCideActivity extends FragmentActivity {
    ...
    private void initDialogResult(Result result) {
        ...
        RxSPTool.putContent(this, RxConstants.SP_SCAN_CODE, RxDataTool.stringToInt(RxSPTool.
                getContent(this, RxConstants.SP_SCAN_CODE)) + 1 + "");
    }
    ...
    public void handleDecode(Result result) {
        ...
        // 处理扫描结果
        if (!TextUtils.isEmpty(result1) && result1.contains("taobao.com")) {
            // 属于淘宝联盟的二维码 - 跳转到淘口令Activity
            // PresenterManager.getInstance().getTicketPressenter().getTicket("", result1, "");
            ...
            // 非淘宝二维码
            ToastUtil.showToast("无法识别非淘宝二维码!");
            finish();
        }
//        if (mScanerListener == null) {
